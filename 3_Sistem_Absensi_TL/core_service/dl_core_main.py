...
class TransferLearning(object):
    ...
    def run(self):
        ...
        self.socketio.emit(self.event, "%s <b>=== Start Transfer Learning ===<b>" % self.get_time())
        self.socketio.sleep(1)
        ...
        self.model.add(Dense(self.dim, name="dense_3"))
        ...
        self.socketio.emit(self.event, "%s Starting Model Optimization for Inference." % self.get_time())
        self.socketio.sleep(1)
