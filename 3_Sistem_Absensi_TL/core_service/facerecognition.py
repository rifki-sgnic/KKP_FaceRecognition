    ...
    def predict(self, frame):
        ...
        for (x, y, w, h) in faces:
            ...
            if confidence > 70:
                ...
                frame = self.draw_ped(frame, label_text, x, y, x + w, y + h, color=(0,255,0), text_color=(50,50,50))

            else :
                label_text = "N/A"
                frame = self.draw_ped(frame, label_text, x, y, x + w, y + h, color=(255,0,0), text_color=(50,50,50))
            
        return frame
    
    
    def draw_ped(self, img, label, x0, y0, xt, yt, color=(255,0,0), text_color=(255,255,255)):
